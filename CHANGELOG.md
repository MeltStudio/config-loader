...
* **ci:** remove registry-url to fix npm OIDC auth conflict ([cf41038](https://github.com/MeltStudio/config-loader/commit/cf4103827575417f7d7dcb15d640cc0f38ae358a))
